...
import 'package:projects/controllers/chat_controller.dart';
import 'package:projects/services/firestore_services.dart';
import 'package:projects/views/chat_screen/components/sender_bubble.dart';
              ...
              : Expanded(
                child: StreamBuilder (
                  ...
                  builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    if(!snapshot.hasData){
                      ...
                      return Center(
                        child: "Send a message.....".text.size(20).color(darkFontGrey).make(), 
                        );
                    }else {
                      return  ListView(
                ...
                Row(
                  children: [
                    ...
                    ).box.height(80).padding(EdgeInsets.all(12)).margin(const EdgeInsets.only(bottom: 8)).make(),
