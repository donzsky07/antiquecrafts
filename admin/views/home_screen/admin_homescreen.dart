...
const SizedBox(height: 40),
 ...
 Widget dashboardContent() {
  ...
  InkWell(
    ...
    child: dashboardCard("Users", users, Icons.people, Colors.blue),
  ),
  ...
  InkWell(
    ...
    child: dashboardCard("Products", products, Icons.shopping_bag, Colors.green),
  ),
  ...
  InkWell(
    ...
    child: dashboardCard("Orders", orders, Icons.shopping_cart, Colors.orange),
  ),

  InkWell(
    onTap: () {
      Get.to(() => const RatingsPage());
    },
    child: dashboardCard("Ratings", ratings, Icons.star, Colors.amber),
  ),
],
          ),
        ),
